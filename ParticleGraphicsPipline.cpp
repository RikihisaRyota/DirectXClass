...
void ParticleGraphicsPipline::DXCCompilerInitialize() {
	HRESULT hr = S_FALSE;
	// dxcCompilerを初期化
...
IDxcBlob* ParticleGraphicsPipline::CompileShader(const std::wstring& filePath, const wchar_t* profile, IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler) {
